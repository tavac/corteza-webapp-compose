<template>
  <b-tab :title="$t('custommodule.label')">
    <b-form-group>
    ...
    <div v-if="selectedModule">
          ...
          <div class="border fields w-100 p-2">
            ...
            >
              ...
              <span class="small float-right">
                <span v-if="field.isSystem">{{
                  $t("field.selector.systemField")
                }}</span>
      ...
      <b-form-group
        ...
        :label-cols="3"
        breakpoint="md"
        :label="$t('custommodule.titleField.label')"
      >
        ...
        <b-form-text>{{ $t("custommodule.titleField.footnote") }}</b-form-text>
      </b-form-group>
      ...
      <b-form-group
        ...
        :label-cols="3"
        breakpoint="md"
        :label="$t('custommodule.contentField.label')"
      >
        ...
        <b-form-text class="text-secondary small">
          {{ $t("custommodule.contentField.footnote") }}
        </b-form-text>
      </b-form-group>
      <b-form-group
        horizontal
        :label-cols="3"
        breakpoint="md"
        :label="$t('custommodule.referenceField.label')"
      >
        ...
        <b-form-text class="text-secondary small">
          {{ $t("custommodule.referenceField.footnote") }}
        </b-form-text>
      </b-form-group>
    </div>
    <b-form-group
      ...
      :label-cols="3"
      breakpoint="md"
      :label="$t('custommodule.sortDirection.label')"
    >
      ...
      <b-form-text class="text-secondary small">
        {{ $t("custommodule.sortDirection.footnote") }}
      </b-form-text>
    </b-form-group>
  </b-tab>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      sortDirections: [
        { label: this.$t('custommodule.sortDirection.asc'), value: 'asc' },
        { label: this.$t('custommodule.sortDirection.desc'), value: 'desc' },
      ],
    }
  },
  computed: {
    ...
    selectedModuleFields () {
      if (this.selectedModule) {
        return [...this.selectedModule.fields].sort((a, b) =>
